            ...
            for (int i = 0; i < size; i++) 
            {
                for (int j = 0; j < size; j++) 
                {
                    ...
                    else 
                    {
                        ...
                        if (int.Parse(map[i, j].Text) > 999) map[i, j].Font = new Font("Comic Sans MS", 26.75F * 4 / size - 4, FontStyle.Bold, GraphicsUnit.Point, 204);
                        if (int.Parse(map[i, j].Text) > 9999) map[i, j].Font = new Font("Comic Sans MS", 26.75F * 4 / size - 8, FontStyle.Bold, GraphicsUnit.Point, 204);
                        if (int.Parse(map[i, j].Text) > 99999) map[i, j].Font = new Font("Comic Sans MS", 26.75F * 4 / size - 12, FontStyle.Bold, GraphicsUnit.Point, 204);
                        if (int.Parse(map[i, j].Text) > 999999) map[i, j].Font = new Font("Comic Sans MS", 26.75F * 4 / size - 16, FontStyle.Bold, GraphicsUnit.Point, 204);
                        if (int.Parse(map[i, j].Text) > 9999999) map[i, j].Font = new Font("Comic Sans MS", 26.75F * 4 / size - 20, FontStyle.Bold, GraphicsUnit.Point, 204);
                    }
                }
            }
        }
